...
namespace protobuf {
	namespace appearances {
		...
		inline const std::string& PLAYER_ACTION_Name(T enum_t_value) {
			static_assert(::std::is_same<T, PLAYER_ACTION>::value || ::std::is_integral<T>::value,
		...
		inline const std::string& ITEM_CATEGORY_Name(T enum_t_value) {
			static_assert(::std::is_same<T, ITEM_CATEGORY>::value || ::std::is_integral<T>::value,
		...
		inline const std::string& PLAYER_PROFESSION_Name(T enum_t_value) {
			static_assert(::std::is_same<T, PLAYER_PROFESSION>::value || ::std::is_integral<T>::value,
		...
		inline const std::string& ANIMATION_LOOP_TYPE_Name(T enum_t_value) {
			static_assert(::std::is_same<T, ANIMATION_LOOP_TYPE>::value || ::std::is_integral<T>::value,
		...
		enum HOOK_TYPE : int { HOOK_TYPE_SOUTH = 1,
			HOOK_TYPE_EAST = 2 };
		...
		inline const std::string& HOOK_TYPE_Name(T enum_t_value) {
			static_assert(::std::is_same<T, HOOK_TYPE>::value || ::std::is_integral<T>::value,
		...
		inline const std::string& FIXED_FRAME_GROUP_Name(T enum_t_value) {
			static_assert(::std::is_same<T, FIXED_FRAME_GROUP>::value || ::std::is_integral<T>::value,
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
		...
		SpriteInfo::_internal_mutable_animation() {
			_impl_._has_bits_[0] |= 0x00000001u;
			if (_impl_.animation_ == nullptr) {
				auto* p = CreateMaybeMessage<::Canary::protobuf::appearances::SpriteAnimation>(
					GetArenaForAllocation());
				_impl_.animation_ = p;
			}
		...
		Appearance::_internal_mutable_flags() {
			_impl_._has_bits_[0] |= 0x00000004u;
			if (_impl_.flags_ == nullptr) {
				auto* p = CreateMaybeMessage<::Canary::protobuf::appearances::AppearanceFlags>(
					GetArenaForAllocation());
				_impl_.flags_ = p;
			}
		...
		AppearanceFlags::_internal_mutable_bank() {
			_impl_._has_bits_[0] |= 0x00000001u;
			if (_impl_.bank_ == nullptr) {
				auto* p = CreateMaybeMessage<::Canary::protobuf::appearances::AppearanceFlagBank>(
					GetArenaForAllocation());
				_impl_.bank_ = p;
			}
			return _impl_.bank_;
		...
		AppearanceFlags::_internal_mutable_hook() {
			_impl_._has_bits_[0] |= 0x00000008u;
			if (_impl_.hook_ == nullptr) {
				auto* p = CreateMaybeMessage<::Canary::protobuf::appearances::AppearanceFlagHook>(
					GetArenaForAllocation());
				_impl_.hook_ = p;
			}
			return _impl_.hook_;
