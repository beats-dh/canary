...
bool ScriptEnvironment::setCallbackId(int32_t newCallbackId,
...
void ScriptEnvironment::getEventInfo(int32_t &retScriptId,
                                     LuaScriptInterface *&retScriptInterface,
                                     int32_t &retCallbackId,
                                     bool &retTimerEvent) const {
