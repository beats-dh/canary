...
void loadModules() {
	...
	modulesLoadHelper((g_luaEnvironment.loadFile(coreFolder + "/core.lua") == 0), "core.lua");
	modulesLoadHelper((g_luaEnvironment.loadFile(coreFolder + "/scripts/talkactions.lua") == 0), "scripts/talkactions.lua");
