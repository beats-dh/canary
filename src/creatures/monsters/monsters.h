...
class Monsters {
	public:
		...
		std::shared_ptr<MonsterType> getMonsterTypeByRaceId(uint16_t thisrace);
	...
	private:
		ConditionDamagePtr getDamageCondition(ConditionType_t conditionType, int32_t maxDamage, int32_t minDamage, int32_t startDamage, uint32_t tickInterval);
};
