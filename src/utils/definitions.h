...
static constexpr auto STATUS_SERVER_DEVELOPERS =
    "OpenTibiaBR Organization, SaiyansKing and Mark Samman";
...
#pragma warning(disable : 4319) // '~': zero extending 'unsigned int' to
                                // 'lua_Number' of greater size
