...
ReturnValue TrashHolder::queryAdd(int32_t, const Thing&, uint32_t, uint32_t,
	Creature*) const {
	return RETURNVALUE_NOERROR;
}

ReturnValue TrashHolder::queryMaxCount(int32_t, const Thing&,
	uint32_t queryCount,
...
Cylinder* TrashHolder::queryDestination(int32_t&, const Thing&, Item**,
	uint32_t&) {
	return this;
}
...
void TrashHolder::postAddNotification(Thing* thing, const Cylinder* oldParent,
