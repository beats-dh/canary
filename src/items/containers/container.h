...
public:
  ...
  virtual Reward *getReward() { return nullptr; }
  virtual const Reward *getReward() const { return nullptr; }
  virtual bool isInbox() const { return false; }
  ...
  bool isUnlocked() const { return !this->isCorpse() && unlocked; }
  ...
  uint32_t getItemTypeCount(uint16_t itemId,
                            int32_t subType = -1) const override final;
