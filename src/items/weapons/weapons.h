...
public:
	...
	static int32_t getMaxWeaponDamage(uint32_t level, int32_t attackSkill,
...
public:
	...
	int32_t playerWeaponCheck(Player* player, Creature* target,
	...
	virtual CombatDamage getCombatDamage(CombatDamage combat, Player* player,
		Item* item,
...
private:
	virtual bool getSkillType(const Player*, const Item*, skills_t&,
		uint32_t&) const {
		return false;
	}
...
public:
	...
	int32_t getWeaponDamage(const Player* player, const Creature* target,
		const Item* item,
...
public:
	...
	int32_t getWeaponDamage(const Player* player, const Creature* target,
		const Item* item,
		bool maxDamage = false) const override;
	int32_t getElementDamage(const Player*, const Creature*,
...
private:
	bool getSkillType(const Player*, const Item*, skills_t&,
