...
public:
	...
	static HistoryMarketOfferList getOwnHistory(MarketAction_t action,
		uint32_t playerId);
	...
	static void createOffer(uint32_t playerId, MarketAction_t action,
	...
	static void appendHistory(uint32_t playerId, MarketAction_t type,
